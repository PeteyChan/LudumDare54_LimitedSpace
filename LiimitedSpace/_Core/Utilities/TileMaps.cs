...
namespace Utils.Tilemaps
{
    ...
    public sealed class Multimesh_Slice25 : ITileMap
    {
        ...
        public bool Has(Godot.Vector3I position) => map.Contains(position);
        public bool Remove(Godot.Vector3I position)
        {
            bool changed = map.Remove(position);
            if (!_updated) _updated = changed;
            return changed;
        }
        public void Clear()
    ...
    public sealed class Multimesh_Path_16_Slice : ITileMap
    {
        ...
        public bool Has(Vector3I position) => map.Contains(position);
...
{
    public static bool Add(this Utils.Tilemaps.ITileMap self, Vector3 position)
        => self.Add(new Vector3I(position.X.Round(), position.Y.Round(), position.Z.Round()));
    public static bool Add(this Utils.Tilemaps.ITileMap self, int x, int y, int z)
        => self.Add(new Vector3I(x, y, z));
    public static bool Add(this Utils.Tilemaps.ITileMap self, int x, int z) => Add(self, x, 0, z);

    public static bool Remove(this Utils.Tilemaps.ITileMap self, int x, int z) => Remove(self, x, 0, z);
    public static bool Remove(this Utils.Tilemaps.ITileMap self, Vector3 position)
        => self.Remove(new Vector3I(position.X.Round(), position.Y.Round(), position.Z.Round()));
    public static bool Remove(this Utils.Tilemaps.ITileMap self, int x, int y, int z)
        => self.Remove(new Vector3(x, y, z));

    public static bool Has(this Utils.Tilemaps.ITileMap self, Vector3 position)
        => self.Has(new Vector3I(position.X.Round(), position.Y.Round(), position.Z.Round()));
    public static bool Has(this Utils.Tilemaps.ITileMap self, int x, int y, int z)
        => self.Has(new Vector3I(x, y, z));
    public static bool Has(this Utils.Tilemaps.ITileMap self, int x, int z) => self.Has(x, 0, z);
}